...
-- vnitrni signal obsahujici tech 6 hodnot - predstavuje stavovou velicinu
  ...
  constant c_DELAY_4SEC : unsigned(4 downto 0) := b"1_0000"; --! 4-second delay 16krat 250 ms (coz je nase upravena casova zakladna) = 4 s
  constant c_DELAY_2SEC : unsigned(4 downto 0) := b"0_1000"; --! 2-second delay 8krat 250 ms = 2 s
...
begin
  ...
  clk_en0 : entity work.clock_enable
    generic map (
      ...
      -- 1   @ 10 ns
      -- 250 00000 @ 250 ms
       g_MAX => 25000000 -- 250 ms / (1/100 MHz)(simulace 1 a realne pak 250ms trojclenka 
    )
    port map (
      clk => clk,
      reset => rst,
